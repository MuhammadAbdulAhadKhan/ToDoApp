...
//   var ToDos = ["Syed Muhammad Arsalan Shah", "Muhammad Abdul Ahad Khan"];
...
//                 child: Text(
//                   "ToDo APP | ${DateFormat("jms").format(time)}",
...
//               child: Text(
//                 "${index + 1}",
//                 style: GoogleFonts.anton(color: Color(0xffe6ae8c)),
//               ),
//             ),
//             title: Text(
//               ToDos[index],
//               style: GoogleFonts.anton(
//                 color: Color.fromARGB(255, 180, 207, 168),
//               ),
//             ),
//             trailing: Row(
...
//                 title: Text(
//                   "Enter Your Task",
//                   style: GoogleFonts.anton(color: Color(0xffa8cecf)),
//                 ),
//                 content: TextField(
//                   onChanged: (value) {
//                     output = value;
        ...
        children: [
          ...
          Center(
            child: Opacity(
              opacity: 0.25,
              child: Image.asset(
                "assets/BG2.jpg", // Your transparent logo
                width: 300,
                height: 300,
                fit: BoxFit.contain,
              ),
